...
export interface ApiAuthorAuthor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    TwitterProfileLink: Attribute.String;
    FacebookProfileLink: Attribute.String;
    InstagramProfileLink: Attribute.String;
    Bio: Attribute.Text;
...
export interface ApiCategoryoldCategoryold extends Schema.CollectionType {
  collectionName: 'oldcategories';
  info: {
    singularName: 'categoryold';
    pluralName: 'oldcategories';
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.UID<'api::categoryold.categoryold', 'name'>;
    description: Attribute.Text;
...
export interface ApiChainChain extends Schema.CollectionType {
  ...
  attributes: {
    Name: Attribute.String;
    Slug: Attribute.UID<'api::chain.chain', 'Name'> & Attribute.Required;
    Logo: Attribute.Media;
    PrimaryColour: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    TagBackground: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    PostBody: Attribute.RichText &
      ...
      >;
    PostSummary: Attribute.Text;
    MainImage: Attribute.Media;
    ReadingTime: Attribute.Integer;
    EditorsChoice: Attribute.Boolean & Attribute.DefaultTo<false>;
    Category: Attribute.Relation<
      'api::post.post',
      'oneToOne',
      'api::category.category'
    >;
    ChainTag: Attribute.Relation<
      'api::post.post',
      'oneToOne',
      'api::chain.chain'
    >;
    MainTag: Attribute.Relation<'api::post.post', 'oneToOne', 'api::tag.tag'>;
    Tags: Attribute.Relation<'api::post.post', 'oneToMany', 'api::tag.tag'>;
    Biography: Attribute.Boolean & Attribute.DefaultTo<false>;
    AMADisclaimer: Attribute.Boolean & Attribute.DefaultTo<false>;
    SponsoredArticleDisclaimer: Attribute.Boolean & Attribute.DefaultTo<false>;
    PressReleaseDisclaimer: Attribute.Boolean & Attribute.DefaultTo<false>;
    OrganicPR: Attribute.Boolean & Attribute.DefaultTo<false>;
    GuestWriterDisclaimer: Attribute.Boolean & Attribute.DefaultTo<false>;
    GeneralDisclaimer: Attribute.Boolean & Attribute.DefaultTo<false>;
    CookieCutter: Attribute.Boolean & Attribute.DefaultTo<false>;
    PremiumContent: Attribute.Boolean & Attribute.DefaultTo<false>;
    DontShowAdBanners: Attribute.Boolean & Attribute.DefaultTo<false>;
    AnandPRs: Attribute.Boolean & Attribute.DefaultTo<false>;
    PublishDate: Attribute.DateTime;
    CmcID: Attribute.Text;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::categoryold.categoryold': ApiCategoryoldCategoryold;
